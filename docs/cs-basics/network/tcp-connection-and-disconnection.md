...
![TCP 三次握手图解](https://pics-cloud.oss-cn-beijing.aliyuncs.com/tcp-shakes-hands-three-times.png)
...
![TCP 四次挥手图解](https://pics-cloud.oss-cn-beijing.aliyuncs.com/tcp-waves-four-times.png)
