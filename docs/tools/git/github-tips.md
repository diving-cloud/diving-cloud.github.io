...
![Github简历](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344448.png)

通过 https://www.githubtrends.io/wrapped 这个网站，你可以生成一份 Github 个人年报，这个年报会列举出你在这一年的项目贡献情况、最常使用的编程语言、详细的贡献信息。

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344298.png)
...
![创建一个和你的Github账户同名的仓库](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344171.png)
...
![通过github-readme-stats动态生成GitHub统计信息 ](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344832.png)
...
![项目徽章](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344006.png)

并且，你不光可以生成静态徽章，shield.io 还可以动态读取你项目的状态并生成对应的徽章。

![自定义项目徽章](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344377.png)

生成的描述项目状态的徽章效果如下图所示。

![描述项目状态的徽章](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344103.png)

## 自动为项目添加贡献情况图标

通过 repobeats 这个工具可以为 Github 项目添加如下图所示的项目贡献基本情况图表，挺不错的 👍

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344645.png)
...
![在线Github表情](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344557.png)
...
![Chrome插件Octotree](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122344716.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345893.png)

使用 SourceGraph 阅读代码的就像下面这样，同样是树形结构展示代码，但是我个人感觉没有 Octotree 的手感舒服。不过，SourceGraph 内置了很多插件，而且还支持类之间的跳转！

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345481.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345770.png)
...
![](<https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345933.png>)

不过，目前 Github 已经自动为 Markdown 文件生成了目录，只是需要通过点击的方式才能显示出来。

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345142.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345671.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122345676.png)
