...
![认识容器](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122340487.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122340363.png)

然后点击`Get Started`：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122340132.png)

在此处点击`Download for Windows`即可进行下载。

如果你的电脑是`Windows 10 64位专业版`的操作系统，则在安装 Docker 之前需要开启一下`Hyper-V`，开启方式如下。打开控制面板，选择程序：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341660.png)

点击`启用或关闭Windows功能`：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341627.png)

勾选上`Hyper-V`，点击确定即可：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341070.png)

完成更改后需要重启一下计算机。

开启了`Hyper-V`后，我们就可以对 Docker 进行安装了，打开安装程序后，等待片刻点击`Ok`即可：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341180.png)

安装完成后，我们仍然需要重启计算机，重启后，若提示如下内容：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341495.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341630.png)

在左上角的搜索框中输入`MySQL`并回车：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341280.png)

可以看到相关 MySQL 的镜像非常多，若右上角有`OFFICIAL IMAGE`标识，则说明是官方镜像，所以我们点击第一个 MySQL 镜像：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341849.png)

右边提供了下载 MySQL 镜像的指令为`docker pull MySQL`，但该指令始终会下载 MySQL 镜像的最新版本。

若是想下载指定版本的镜像，则点击下面的`View Available Tags`：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341984.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341765.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341080.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341297.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341110.png)

若是查询的版本不存在，则结果为空：

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122341064.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342912.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342201.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342508.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342599.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342218.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342537.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342163.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122342118.png)
