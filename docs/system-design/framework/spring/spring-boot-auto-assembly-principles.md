...
- `@ComponentScan`： 扫描被`@Component` (`@Service`,`@Controller`)注解的 bean，注解默认会扫描启动类所在的包下所有的类 ，可以自定义不扫描某些 bean。如下图所示，容器中将排除`TypeExcludeFilter`和`AutoConfigurationExcludeFilter`。
  ...
  ![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122326070.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122326619.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122326831.png)

**第 2 步** ：

用于获取`EnableAutoConfiguration`注解中的 `exclude` 和 `excludeName`。

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122326302.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122326746.png)

从下图可以看到这个文件的配置内容都被我们读取到了。`XXXAutoConfiguration`的作用就是按需加载组件。

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122326250.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327756.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327771.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327992.png)

第二步，引入 Spring Boot 相关依赖

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327704.png)

第三步，创建`ThreadPoolAutoConfiguration`

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327114.png)

第四步，在`threadpool-spring-boot-starter`工程的 resources 包下创建`META-INF/spring.factories`文件

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327714.png)

最后新建工程引入`threadpool-spring-boot-starter`

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327384.png)

测试通过！！！

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122327403.png)
