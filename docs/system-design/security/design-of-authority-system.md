...
![RBAC 权限模型示意图](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122335998.png)
...
![新权限系统方案](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122335574.png)
...
![系统接入流程图](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122335122.png)
...
![系统管理界面设计](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122335238.png)

#### 菜单管理

新权限系统首先对菜单进行了分类，分别是 `目录`、`菜单` 和 `操作`，示意如下图

![菜单管理界面](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122335195.png)
...
![菜单管理界面设计](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122335534.png)
...
![角色与用户管理模块设计](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122336222.png)
...
![权限申请界面](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122336252.png)
