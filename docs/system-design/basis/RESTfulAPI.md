...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122333281.png)

**API（Application Programming Interface）** 翻译过来是应用程序编程接口的意思。

我们在进行后端开发的时候，主要的工作就是为前端或者其他后端服务提供 API 比如查询用户数据的 API 。

![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122333277.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303122333621.png)
