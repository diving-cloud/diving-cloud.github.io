...
![image-20230320221945348](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312043.png)
...
![image-20230320222057692](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312145.png)

ELK 日志采集系统架构（负责日志的搜索）：

![image-20230320222111521](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312052.png)
...
![image-20230320223651242](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312013.png)
...
1建立文档列表，每个文档都有一个唯一的文档 ID 与之对应。
2通过分词器对文档进行分词，生成类似于 <词语，文档ID> 的一组组数据。
3将词语作为索引关键字，记录下词语和文档的对应关系，也就是哪些文档中包含了该词语。

这里可以记录更多信息比如词语的位置、词语出现的频率，这样可以方便高亮显示以及对搜索结果进行排序（后文会介绍到）。

Lucene 的倒排索引大致是下面这样的（图源：https://segmentfault.com/a/1190000037658997）：

![9d497286-fc55-4ad7-835e-2c0beeda6d37 (1)](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312109.jpeg)
...
![c8b1edc4-5529-4426-825a-b7bbf5b525da](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312018.png)
...
![8390a51f-d5be-4c3f-8053-3bd177afcd51](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312773.png)
...
![f2ca3548-2029-4ad4-93d3-dbf761bb4c16 (1)](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312604.png)
...
1创建临时 Index，插入一些临时数据；
2访问 Mapping API ,获取相关 Mapping 定义；
3在此基础上进行修改，如添加 keyword，nested类型；
4删除临时 Index。
...
![4f30bb09-ae17-4d30-8bec-afb58d4e919f (1)](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312017.png)
...
- 叶子查询：指定条件指定字段查询，包括term**分词查询**和**全文检索**（match，match_phrase)
...
![987df2b8-e06c-4cbe-be71-9743b01c9b98](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312848.png)
...
2. 2MySQL Master 节点接收到请求之后，根据偏移量将新的 binlog 发送给 MySQL Slave 节点；
3. 3Canal 接收到 binlog 之后，就可以对这部分日志进行解析，获取主库的结构及数据变更。

![image-20230321230427641](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312822.png)
...
![9b78cbe7-2601-490d-b663-905bc798469b](https://pics-cloud.oss-cn-beijing.aliyuncs.com/202303212312956.png)
