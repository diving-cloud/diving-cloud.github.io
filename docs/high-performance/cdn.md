...
![京东仓配系统](https://pics-cloud.oss-cn-beijing.aliyuncs.com/jingdong-wuliu-cangpei.png)

你可以将 CDN 看作是服务上一层的特殊缓存服务，分布在全国各地，主要用来处理静态资源的请求。

![CDN 简易示意图](https://pics-cloud.oss-cn-beijing.aliyuncs.com/cdn-101.png)
...
![CDN 原理示意图](https://pics-cloud.oss-cn-beijing.aliyuncs.com/cdn-overview.png)
...
![腾讯云 CDN Referer 防盗链配置](https://pics-cloud.oss-cn-beijing.aliyuncs.com/cnd-tencent-cloud-anti-theft.png)
...
![](https://pics-cloud.oss-cn-beijing.aliyuncs.com/timestamp-anti-theft.png)
